...
public class View {
    ...
    public static final String INPUT_HOME_NUMBER = "Input home number in format xxx-xxx-xx-xx. ";
    public static final String INPUT_MOBILE_NUMBER = "Input mobile number in format xxx-xxx-xx-xx.  ";
    public static final String INPUT_MOBILE_NUMBER2 = "Input mobile number in format xxx-xxx-xx-xx.  ";
