...
public class InputRegForm {
    ...
    private static String homePhoneNumber;
    private static String mobilePhoneNumber;
    private static String mobilePhoneNumber2;
    ...
    private static String modifyData;
    ...
    public static String getHomePhoneNumber() {
    ...
    public static String getMobilePhoneNumber2() {
    ...
    public static String getCreateData() {
        return createData;
    }
